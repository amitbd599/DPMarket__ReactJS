          ...
          <div className="col-lg-4 pe-xl-5">
            <div className="setting-sidebar top-24">
              ...
              <ul className="setting-sidebar-list">
                ...
                <li className="setting-sidebar-list__item">
                  <a to="#profile" className="setting-sidebar-list__link">
                    Profile
                  </a>
                </li>
                <li className="setting-sidebar-list__item">
                  <a to="#paymentSystem" className="setting-sidebar-list__link">
                    Setup Payment System
                  </a>
                </li>
                <li className="setting-sidebar-list__item">
                  <a to="#emailSetting" className="setting-sidebar-list__link">
                    Email Setting
                  </a>
                </li>
                <li className="setting-sidebar-list__item">
                  <a to="#socialNetwork" className="setting-sidebar-list__link">
                    Social Networks
                  </a>
                </li>
              </ul>
